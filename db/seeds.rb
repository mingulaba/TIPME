...
file = URI.open("https://res.cloudinary.com/dcsnvqusv/image/upload/v1670837225/Keshe_lookalike_mtbpr3.jpg")
team_member1 = TeamMember.new(first_name: "Phillip", last_name: "Johnson", birth_date: Date.new(2001, 4, 23), av_rating: 0.0, restaurant_id: 2, user_id: 2, introduction: "I would like to save up for fun")
...
file = URI.open("https://res.cloudinary.com/dcsnvqusv/image/upload/v1670844627/Sally_vky9lx.jpg")
team_member2 = TeamMember.new(first_name: "Sally", last_name: "Strings", birth_date: Date.new(1995, 7, 15), av_rating: 0.0, restaurant_id: 2, user_id: 3, introduction: "I would like to save up for my education as a Designer")
...
team_member3 = TeamMember.new(first_name: "George", last_name: "Ullagso", birth_date: Date.new(1992, 5, 11), av_rating: 0.0, restaurant_id: 1, user_id: 4, introduction: "I would like to save up for a cooking school")
...
file = URI.open("https://res.cloudinary.com/dcsnvqusv/image/upload/v1670845142/Karoline_b5en38.jpg")
team_member4 = TeamMember.new(first_name: "Karoline", last_name: "Riviera", birth_date: Date.new(1989, 8, 22), av_rating: 0.0, restaurant_id: 1, user_id: 5, introduction: "I would like to save up to open my own restaurant")
...
team_member5 = TeamMember.new(first_name: "Stevey", last_name: "Baldwin", birth_date: Date.new(1997, 1, 29), av_rating: 0.0, restaurant_id: 2, user_id: 6, introduction: "I would like to save up for Antarktica expedition")
...
team_member6 = TeamMember.new(first_name: "Chester", last_name: "Mayfieldy", birth_date: Date.new(1986, 7, 30), av_rating: 0.0, restaurant_id: 1, user_id: 7, introduction: "I would like to save up to buy a new car for my dad")
...
team_member7 = TeamMember.new(first_name: "David", last_name: "Schriner", birth_date: Date.new(2000, 11, 5), av_rating: 0.0, restaurant_id: 1, user_id: 8, introduction: "I would like to save up for a boat trip")
...
file = URI.open("https://res.cloudinary.com/dcsnvqusv/image/upload/v1670424974/TFT-Sinking-Manager-RAW-1024x640_bap87s.jpg")
team_member8 = TeamMember.new(first_name: "Tobias", last_name: "Fiellmann", birth_date: Date.new(1998, 10, 31), av_rating: 0.0, restaurant_id: 1, user_id: 9, introduction: "I would like to save up to make an unforgettable date")
...
team_member9 = TeamMember.new(first_name: "Sarah", last_name: "Donaldson", birth_date: Date.new(1995, 12, 27), av_rating: 0.0, restaurant_id: 2, user_id: 10, introduction: "I would like to save up for a Patagonia trip")
...
team_member10 = TeamMember.new(first_name: "Chloe", last_name: "Festjacke", birth_date: Date.new(1989, 1, 5), av_rating: 0.0, restaurant_id: 1, user_id: 11, introduction: "I would like to save up to upgrade my apartment")
...
team_member11 = TeamMember.new(first_name: "Ulf", last_name: "Weiner", birth_date: Date.new(1985, 8, 17), av_rating: 0.0, restaurant_id: 2, user_id: 12, introduction: "I would like to save up for a new mountain bike")
...
team_member12 = TeamMember.new(first_name: "Galvin", last_name: "Totbringer", birth_date: Date.new(1988, 2, 14), av_rating: 0.0, restaurant_id: 2, user_id: 13, introduction: "I would like to save up for Le Wagon Bootcamp")
